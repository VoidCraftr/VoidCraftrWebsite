  ...
  const contactMethods = [
    {
      ...
      contact: "satyam.agarwal.in@gmail.com",
      action: "mailto:satyam.agarwal.in@gmail.com",
    },
    {
      icon: <Phone className="h-6 w-6" />,
      title: "Call Us",
      description: "Speak directly with our team during business hours",
      contact: "+91 9265372319",
      action: "tel:+919265372319",
    },
    {
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center max-w-4xl mx-auto">
            ...
            <p className="text-xl text-gray-300 mb-8">
              Ready to transform your business with innovative technology? Get
              in touch with our expert team for a free consultation.
            </p>
                  ...
                  {[
                    {
                      ...
                      description:
                        "We respond to all inquiries within 24 hours, ensuring you never wait long for answers.",
                    },
                    {
                    ...
                    },
                    {
                      ...
                      description:
                        "Regular updates and clear communication throughout your project lifecycle.",
                    },
                  ].map((benefit, index) => (
